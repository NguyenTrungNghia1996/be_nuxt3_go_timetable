...
type Menu struct {
	...
	UnitID  *primitive.ObjectID `json:"unit_id,omitempty" bson:"unit_id,omitempty"`
	IsSA    bool                `json:"is_sa" bson:"is_sa"`
...
type MenuResponse struct {
	...
	UnitID  *primitive.ObjectID `json:"unit_id,omitempty"`
